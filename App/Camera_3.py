...
face_classifier = keras.models.load_model(r'C:\MyProject\397199_397209\Models\ThreeClassModel6_model.h5')
face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')
class_names = ['Gozler Kapali', 'Sol Goz Kirpiliyor','Sag Goz Kirpiliyor']
